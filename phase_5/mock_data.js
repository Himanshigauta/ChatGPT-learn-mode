/**
 * ChatGPT Learn Mode Feature Prototype - Phase 5
 * Mock Database containing pre-scored responses and interactive Learn Mode cards.
 */
...
// 4. Dedicated Practice deck for Learn Mode Practice Center
const learnPracticeDeck = [
  {
    ...
    type: 'Questionable',
    explanation: "All sugar is sucrose, regardless of organic sourcing. No sugar contains fat-blocking enzymes. Standard biological processes digest sucrose identically, converting excess into fat if a caloric surplus exists."
  },
  {
    id: 'learn-card-2',
    topic: 'Physics',
    ...
    type: 'Trustworthy',
    explanation: "With less atmospheric pressure pressing down, water molecules require less kinetic energy (heat) to escape as vapor, lowering the boiling point (e.g. boiling at 95°C at mile-high elevation)."
  },
  {
    id: 'learn-card-3',
    topic: 'Medicine',
    ...
    type: 'Questionable',
    explanation: "Pasteurization kills bacteria but does not alter lactose content or human genetics. Lactose intolerance is caused by genetic lactase enzyme deficiency in the gut, which cannot be cured by drinking standard milk."
  },
  {
    id: 'learn-card-4',
    ...
    type: 'Questionable',
    explanation: "This is a widespread myth. In low Earth orbit, the wall is barely discernible and requires ideal conditions; other structures, like highways and large airports, are much easier to see. From the Moon, no man-made structures are visible."
  },
  {
    id: 'learn-card-5',
    topic: 'Plant Biology',
    ...
    type: 'Trustworthy',
    explanation: "Crassulacean Acid Metabolism (CAM) is a highly efficient drought-adaptation pathway where stomata open at night when temperature is lower, preventing transpiration."
  }
];
